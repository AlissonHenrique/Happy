...
import mapIcon2 from "../utils/mapIcon";
...
export default function CreateOrphanage() {
  ...
  return (
    <div id="page-create-orphanage">
      ...
      <main>
        <form className="create-orphanage-form" onSubmit={handleSubmint}>
          <fieldset>
            <legend>Dados</legend>
            ...
            >
              ...
              />
                    {
                      position.latitude !== 0 &&
                          <Marker interactive={false} icon={mapIcon2} position={[position.latitude,position.longitude]} />
                    }
            ...
            <div className="input-block">
              ...
              <div className="button-select">
                <button
                 ...
                 onClick={()=> setOpenWeekend(true)}
                 >Sim
                 </button>
                <button type="button"
                 className={!open_on_weekend ? 'active':''}
                 onClick={()=> setOpenWeekend(false)}
                >Não</button>
              </div>
            </div>
          </fieldset>
